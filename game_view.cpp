...
void game_view::update() {
    ...
    cout << model.get_points() << endl << endl;
    SetConsoleTextAttribute(h, 15);
    cout << "Level: ";
    SetConsoleTextAttribute(h, 10);
    cout << model.get_level() << endl << endl;
    SetConsoleTextAttribute(h, 15);
    cout << "To next level you need ";
    if (model.to_next_level() == 1) {
        SetConsoleTextAttribute(h, 10);
        cout << model.to_next_level();
        SetConsoleTextAttribute(h, 15);
        cout << " click";
    } else {
        SetConsoleTextAttribute(h, 10);
    ...
    cout << char(206) << " ";
    cout << (model.ranks(model.get_level()));
    cout << " " << char(206);
    SetConsoleTextAttribute(h, 15);
    cout << endl;
...
void game_view::title() {
    ...
    cout << R"( |  \/  | /_\ | __|_ _| /_\    / __| |  |_ _/ __| |/ / __| _ \)" << endl;
    cout << R"( | |\/| |/ _ \| _| | | / _ \  | (__| |__ | | (__| ' <| _||   / )" << endl;
    cout << R"( |_|  |_/_/ \_\_| |___/_/ \_\  \___|____|___\___|_|\_\___|_|_\ )" << endl << endl << endl;
